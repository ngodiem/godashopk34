 <div class="product-container">
                        ...
                        <div class="product-meta">
                            <h5 class="name">
                                <!-- click vào tên sp -->
                                <a class="product-name" href="<?=$router->generate("product-detail", ["slugName" => slugify($product->getName()), "id"=>$product->getId()])?>" title="<?=$product->getName()?>"><?=$product->getName()?></a>
                            </h5>
                        ...
                        <?php endif ?>
                            <div class="quickview icon">
                                <a class="btn btn-outline-inverse" href="<?=$router->generate("product-detail", ["slugName" => slugify($product->getName()), "id"=>$product->getId()])?>" title="Xem nhanh">
