    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?= in_array($routeName, ["product", "product-detail", "price-range", "serach", "category"])? "active": ""?>" href="<?=$router->generate("product")?>">Sản phẩm</a>
                <a class="<?=$routeName=="returnPolicy"? "active": ""?>" href="<?=$router->generate("returnPolicy")?>">Chính
                    sách đổi trả</a>
                <a class="<?=$routeName=="paymentPolicy"? "active": ""?>" href="<?=$router->generate("paymentPolicy")?>">Chính
                    sách thanh toán</a>
                <a class="<?=$routeName=="deliveryPolicy"? "active": ""?>" href="<?=$router->generate("deliveryPolicy")?>">Chính
                    sách giao hàng</a>
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?= in_array($routeName, ["product", "product-detail", "price-range", "serach", "category"])? "active": ""?>"><a href="<?=$router->generate("product")?>">Sản phẩm </a></li>
                <li class="<?=$routeName=="returnPolicy"? "active": ""?>"><a href="<?=$router->generate("returnPolicy")?>">Chính
                        sách đổi trả</a></li>
